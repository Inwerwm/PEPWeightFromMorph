...
{
    public class WeightFromMorph : PEPluginClass
    {
        public WeightFromMorph() : base()
        {
        }
        ...
        public override IPEPluginOption Option
        {
            get
            {
                ...
                return new PEPluginOption(false, true, "頂点モーフからウェイト設定");
            }
        }
